...
class APA102(LEDStrip):
    ...
    def on_color_change(self, led_num, red: float, green: float, blue: float) -> None:
        # gamma correction
        r_corrected = self.gamma_correction(red, self.gamma)
        g_corrected = self.gamma_correction(green, self.gamma)
        b_corrected = self.gamma_correction(blue, self.gamma)
        ...
        self.leds[start_index + 3] = r_corrected
        self.leds[start_index + 2] = g_corrected
        self.leds[start_index + 1] = b_corrected
