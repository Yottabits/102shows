...
# -*- coding: utf-8 -*-
#
# 102shows documentation build configuration file, created by
...
latex_documents = [
    (master_doc, '102shows.tex', '102shows Documentation',
     'Simon Leiner', 'manual'),
]
